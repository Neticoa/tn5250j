...
public class ByteExplainer {
    ...
    public static boolean isDataEBCDIC(final int aByte) {
        final int justByte = aByte & 0xff;
        return !isShiftOut(justByte) || !isShiftIn(justByte) || (justByte >= 64 && justByte < 255);
    }

    public static boolean isShiftIn(final int aByte) {
        return (aByte & 0xff) == SHIFT_IN;
    }

    public static boolean isShiftOut(final int aByte) {
        return (aByte & 0xff) == SHIFT_OUT;
    }

    public static boolean isAttribute(final int byte0) {
     ...
     * @return true|false
     */
    public static boolean isDataUnicode(final int data) {
